...
try:
    ...
    #с ожиданием если button1 = WebDriverWait(browser, 10).until(
    #EC.element_to_be_clickable((By.CSS_SELECTOR, ".btn-add-to-basket"))
    #)
    #Сам элемент вот такой <button type="submit" class="btn btn-lg btn-primary btn-add-to-basket" value="Добавить в корзину" data-loading-text="Добавление...">Добавить в корзину</button>
    print(button1.text)
